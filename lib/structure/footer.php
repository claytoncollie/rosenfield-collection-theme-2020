...
function do_footer_credits() {
	...
	printf(
		'<div><span class="copyright">%s %s</span><span class="entry-sep">&middot;</span><span class="credits">%s</span><span class="entry-sep">&middot;</span><span class="login">%s</span></div>',
