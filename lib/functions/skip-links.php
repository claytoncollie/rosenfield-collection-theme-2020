...
function skip_links( array $links ) : array {
	...
	if ( is_search() ) {
		$links['rosenfield-collection-current-refinements'] = esc_html__( 'Skip to current refinements', 'rosenfield-collection-2020' );
	}
	...
	$links['rosenfield-collection-footer-credits'] = esc_html__( 'Skip to footer credits', 'rosenfield-collection-2020' );
