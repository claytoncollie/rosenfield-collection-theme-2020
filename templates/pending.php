...
// Add pending filter.
\add_action( 'genesis_hero_section', 'RosenfieldCollection\Theme2020\Functions\do_pending_filter_by_form', 25 );
\add_action( 'genesis_hero_section', 'RosenfieldCollection\Theme2020\Functions\do_pending_filter_by_artist', 25 );
