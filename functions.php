...
require_once ROSENFIELD_COLLECTION_THEME_INCLUDES_PATH . 'gravity-forms-styles.php';
require_once ROSENFIELD_COLLECTION_THEME_INCLUDES_PATH . 'gravity-forms-submissions.php';
...
require_once ROSENFIELD_COLLECTION_THEME_INCLUDES_PATH . 'structure/layout.php';
...
require_once ROSENFIELD_COLLECTION_THEME_INCLUDES_PATH . 'structure/site-container.php';
require_once ROSENFIELD_COLLECTION_THEME_INCLUDES_PATH . 'structure/site-footer.php';
require_once ROSENFIELD_COLLECTION_THEME_INCLUDES_PATH . 'structure/site-header.php';
require_once ROSENFIELD_COLLECTION_THEME_INCLUDES_PATH . 'structure/site-inner.php';
...
\RosenfieldCollection\Theme\GravityFormsStyles\setup();
\RosenfieldCollection\Theme\GravityFormsSubmissions\setup();
...
\RosenfieldCollection\Theme\Structure\Layout\setup();
...
\RosenfieldCollection\Theme\Structure\SiteContainer\setup();
\RosenfieldCollection\Theme\Structure\SiteFooter\setup();
\RosenfieldCollection\Theme\Structure\SiteHeader\setup();
\RosenfieldCollection\Theme\Structure\SiteInner\setup();
